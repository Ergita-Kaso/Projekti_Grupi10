...
$_SESSION['error']="Ju lutemi plotesoni kategorine dhe mesazhin.";
...
<div class="privacy">
    <div class="container">
        ...
        <form name="issueform" method="post" class="issue-form">
            ...
            <label>Mesazhi</label>
            <textarea name="description" class="form-control" rows="5" placeholder="Shkruani mesazhin tuaj" required></textarea>
