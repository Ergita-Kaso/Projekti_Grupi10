...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Vendosni Emrin</b>  <input type="text" name="fname" class="form-control" id="fname" placeholder="Emri i plote" required="">
	</p> 
<p style="width: 350px;">
<b>E-mail</b>  <input type="email" name="email" class="form-control" id="email" placeholder="Email i vlefshem" required="">
	</p> 

	<p style="width: 350px;">
<b>Numri i Telefonit</b>  <input type="text" name="mobileno" class="form-control" id="mobileno" maxlength="10" placeholder="Numri i telefonit" required="">
	</p> 

	<p style="width: 350px;">
<b>Titulli</b>  <input type="text" name="subject" class="form-control" id="subject"  placeholder="Subjekti" required="">
	</p> 
	<p style="width: 350px;">
<b>Mesazhi</b>  <textarea name="description" class="form-control" rows="6" cols="50" id="description"  placeholder="Pershkrimi" required=""></textarea> 
	</p> 
