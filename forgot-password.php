...
include_once('includes/password-helper.php');
include_once('includes/validation-helper.php');
if(isset($_POST['submit50']))
	{
$email=dreamCleanInput($_POST['email']);
$mobile=dreamCleanInput($_POST['mobile']);
$newRawPassword=(string) $_POST['newpassword'];
$newpassword=dreamPasswordHash($newRawPassword);
...
} else if(!dreamValidPassword($newRawPassword)) {
$error="Fjalekalimi i ri duhet te kete 6 deri ne 72 karaktere.";
} else {
...
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Email </b>  <input type="email" name="email" class="form-control" id="email" placeholder=" Email" maxlength="120" required="">
	</p> 

	<p style="width: 350px;">
		
			<b>Numri telefonit </b>  <input type="tel" name="mobile" class="form-control" id="mobile" placeholder="Nr.itelefonit" minlength="7" maxlength="20" pattern="[0-9+()\-\s]{7,20}" required="">
	</p> 

<p style="width: 350px;">
<b>Fjalekalimi i ri </b>
<input type="password" class="form-control" name="newpassword" id="newpassword" placeholder="Fjalekalimi i ri" minlength="6" maxlength="72" required="">
</p>

<p style="width: 350px;">
<b>Konfirmo Fjalekalimin </b>
	<input type="password" class="form-control" name="confirmpassword" id="confirmpassword" placeholder="Konfirmo Fjalekalimin" minlength="6" maxlength="72" required="">
			</p>
