						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="password" name="password" class="form-control1" id="exampleInputPassword1" placeholder="Fjalekalimi Aktual" minlength="6" maxlength="72" required="">
								</div>
							</div>
						</div>
	...
	<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="password" class="form-control1" name="newpassword" id="newpassword" placeholder="Fjalekalimi i Ri" minlength="6" maxlength="72" required="">
								</div>
							</div>
						</div>
	...
	<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="password" class="form-control1" name="confirmpassword" id="confirmpassword" placeholder="Konfirmo Fjalekalimin" minlength="6" maxlength="72" required="">
								</div>
							</div>
						</div>
