...
$pimage='';
if(!dreamValidateUploadedImage($_FILES["packageimage"], $pimage, $error)) {
...
<html>
<head>
<title>Dream Travel Admin</title>
...
<ol class="breadcrumb">
           <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Ndrysho Foton e Paketes </li>
            </ol>
		
 	<div class="grid-form">
 
  <div class="grid-form1">
  	       <h3>Ndrysho Foton e Paketes </h3>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Foto e re</label>
									<div class="col-sm-8">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="submit" class="btn-primary btn">Ndrysho</button> <a href="update-package.php?pid=<?php echo htmlentities($imgid);?>" class="btn btn-default">Kthehu te modifikimi i fushave</a>
...
<!--perfshirja e te drejtes se autorit-->
