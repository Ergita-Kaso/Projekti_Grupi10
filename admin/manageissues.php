...
<html>
<head>
<title>Dream Travel | Ceshtje te menaxhimit - Admin</title>
...
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i> Menaxho </li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Menaxho Ceshtjet</h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th><center>#</center></th>
							<th><center>Emri</center></th>
							<th><center>Numri i telefonit</center></th>
							<th><center>Email </center></th>
							<th><center>Ceshtjet</center> </th>
						...
						<tbody>
<?php $sql = "SELECT tblissues.id as id,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tblissues.Issue as issue,tblissues.Description as Description,tblissues.PostingDate as PostingDate,tblissues.AdminRemark as AdminRemark,tblissues.AdminremarkDate as AdminremarkDate from tblissues join tblusers on tblusers.EmailId=tblissues.UserEmail order by tblissues.PostingDate desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
			...
			<td><?php if($result->AdminRemark){?><span class="admin-status admin-status-read">Pergjigjur</span><?php } else {?><span class="admin-status admin-status-pending">Ne pritje</span><?php } ?></td>
			<td><?php echo $result->AdminremarkDate ? htmlentities($result->AdminremarkDate) : '-';?></td>
			<td class="package-actions"><a class="btn btn-primary btn-sm" href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>', 100, 100, 600, 600);">Lexo / Pergjigju</a></td>
