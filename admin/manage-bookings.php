...
header('location:index.php');
	...
	//kodi per anullimin e rezervimeve
...
$msg="Prenotimi u anullua me sukses!";
}
...
$query -> execute();
$msg="Prenotimi u konfirmua me sukses!";
}
...
<html>
<head>
<title>Dream Travel | Menaxhimi i prenotimeve Admin </title>
...
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Menaxho Prenotimet</li>
            </ol>
...
{
echo "Anulluar nga Perdoruesi " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Anulluar</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Jeni te sigurte qe doni ta anulloni ?')" >Anullo</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Jeni te sigurte qe doni ta konfirmoni ?')" >Konfirmo</a></td>
<?php }?>
