...
{
$issue=dreamCleanInput($_POST['issue']);
$description=dreamCleanInput($_POST['description']);
$email=$_SESSION['login'];
if(strlen($email)==0) {
$_SESSION['msg']="Ju lutemi logohuni per te derguar mesazh.";
echo "<script type='text/javascript'> document.location = 'index.php'; </script>";
exit;
} else if(!dreamAllowedValue($issue, array('Probleme me Rezervimin','Anullime','Ulje','Te Tjera'))) {
$_SESSION['msg']="Zgjidhni nje kategori te vlefshme.";
echo "<script type='text/javascript'> document.location = 'issuetickets.php'; </script>";
exit;
} else if(!dreamTextLength($description, 10, 1000)) {
$_SESSION['msg']="Pershkrimi duhet te kete 10 deri ne 1000 karaktere.";
echo "<script type='text/javascript'> document.location = 'issuetickets.php'; </script>";
exit;
}
									...
									<div class="writ">
										<h4>Si mund t'iu ndihmojme </h4>
											<ul>
												...
												<li class="descrip">
									<input class="special" type="text" placeholder="Pershkrimi"  name="description" minlength="10" maxlength="1000" required="">
												</li>
