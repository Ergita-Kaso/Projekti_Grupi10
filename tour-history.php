...
{
$error="Ju nuk mund te anulloni rezervimin para 24 oreve!";
}
}
}
}
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Historiku i rezervimeve te mia</h3>
...
<tr align="center">
<th>#</th>
<th><center>Rezervimi</center></th>
<th><center>Emri i paketes</center></th>	
<th><center>Nga</center></th>
<th><center>Ne</center></th>
<th><center>Koment</center></th>
<th><center>Statusi</center></th>
<th><center>Data e Rezervimit</center></th>
...
{
echo "U anullua nga ju ne  " .$result->upddate;
} 
if($result->status==2 and $result->cancelby=='a')
{
echo "Anulluar nga Admin " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Anulluar</td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Jeni te sigurt qe doni te anulloni prenotimin?')" >Anullo</a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
